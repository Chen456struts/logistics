package com.cchong.logistics.shiro;
...
public class JWTRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        //用户的角色
		if("高级管理员".equals(user.getRemarks()))
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken)  {
		...
		if("A".equals(bd)){
			...
			DriverInformation driverInformation = driverInformationMapper.selectByPrimaryKey(id);
			...
			ShipperInformation shipperInformation = shipperInformationMapper.selectByPrimaryKey(id);
